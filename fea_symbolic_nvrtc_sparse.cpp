...
g++ -O2 --std=c++11 fea_symbolic_nvrtc_sparse.cpp -o fea_symbolic_nvrtc_sparse -I $CUDA_PATH/include -L $CUDA_PATH/lib64 -lginac -lnvrtc -lcuda -Wl,-rpath,$CUDA_PATH/lib64
*/
int main()
{
